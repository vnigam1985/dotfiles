...
alias scpb='scp -F $(~/garuda/provisioning/ssh-cfg.sh)'
alias gbuild='source ~/.gce_build_bbm;gcloud compute instances list'
alias gint='source ~/.gce_int_bbm;gcloud compute instances list'
alias gdev='source ~/.gce_dev_bbm;gcloud compute instances list'
alias gprod='source ~/.gce_production_bbm;gcloud compute instances list'
alias gprodx='source ~/.gce_production_x $1;gcloud compute instances list'
alias gintx='source ~/.gce_int_x $1;gcloud compute instances list'
alias xc='xclip -sel clip <'
alias gkms='~/garuda/scripts/gkms.sh'
